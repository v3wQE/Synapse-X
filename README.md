...
execute.MouseButton1Click:Connect(function()
    ...
    if injected == false then
        title.Text = "Synapse X - v2.21.0d (not injected! press attach)"
    end
end)
...
Attach.MouseButton1Click:Connect(function()
    print("hi")
    if injected == true then
        title.Text = "Synapse X - v2.21.0d (already injected!)"
        wait(1)
        title.Text = "Synapse X - v2.21.0d"
    end
    if injected == false then
        title.Text = "Synapse X - v2.21.0d (checking...)"
        wait(0.1)
        title.Text = "Synapse X - v2.21.0d (injecting...)"
        wait(1.5)
        title.Text = "Synapse X - v2.21.0d (checking whitelist...)"
        wait(0.8)
        title.Text = "Synapse X - v2.21.0d (scanning...)"
        wait(0.3)
        title.Text = "Synapse X - v2.21.0d (ready!)"
        wait(0.5)
        title.Text = "Synapse X - v2.21.0d"
        injected = true
    end
